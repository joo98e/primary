...
top.window.addEventListener('resize', function () {
    var con_W = parent.document.getElementsByTagName('body')[0].offsetWidth;
    var con_H = parent.document.getElementsByTagName('body')[0].offsetHeight;

    // parent.parent.document.getElementsByTagName('body').style.position = 'relative';
});
